...
- AI анализирует текст и классифицирует лид
...
2. Добавь credentials:
   ...
   - Telegram Bot token
   - Google Sheets Service Account
3. Создай таблицу `ai-lead-qualifier-logs` с колонками: timestamp, name, contact, category, priority, reason
4. Дай доступ Service Account к таблице
